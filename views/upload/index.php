 ...
 <div class="card ">
     <div class="card-body ">
         <ul class="nav nav-tabs tab-solid tab-solid-danger link" role="tablist">
         
         </ul>
         <div class="tab-content tab-content-solid link2">
 ...
 <script>
      $(document).on('change',"#file_upload_genome",function() {
     ...
     $(document).on('click',".btn-upload-genome",function() {
  ...
  <script>
     ...
     $(document).on('click',".btn-upload-location",function() {
 ...
 <script>
     ...
     load();
     function load(){
      let link =   sessionStorage.getItem("upload");
      if(link == 'character'){
          $('.link2').append(  `
          <div class="tab-pane fade active show" id="home-5-1" role="tabpanel" aria-labelledby="tab-5-1">
                 <div class="m-4">
                     <h2>Upload Characterization File </h2>
                     <form id="upload" method="post" action="http://localhost/user_plant/upload/check_data" enctype="multipart/form-data">
                         <div id="drop">
        ...
        $('.link2').append(  `
        <div class="tab-pane fade active show" id="profile-5-2" role="tabpanel" aria-labelledby="tab-5-2">
                 <div class="m-4">
                     <h2>Upload Location File </h2>
                     <form id="upload_location" method="post" action="http://localhost/user_plant/upload/check_data_location" enctype="multipart/form-data">
                         <div id="drop">
                         ...
                         <p>**example file to upload<a class="green" href="http://localhost/user_plant/public/example_location.xlsx" target="_blank" download="passport_data"><span class="padding-left-10"><i class="font-20 fas fa-file-upload"></i>download </span></a></p>
        ...
        $('.link').append(`
        <li class="nav-item ">
             <a class="nav-link active" id="tab-5-2" data-toggle="tab" href="#profile-5-2" role="tab" aria-controls="profile-5-2" aria-selected="false">Location</a>
         </li>
          `)
      }
      else{
        $('.link2').append(  `
        <div class="tab-pane fade active show" id="contact-5-3" role="tabpanel" aria-labelledby="tab-5-3">
                 <div class="m-4">
                     ...
                     <form id="upload_genome" method="post" action="<?php echo URL ?>upload/check_data_genome" enctype="multipart/form-data">
                         ...
                         <p>**example file to upload<a class="green" href="http://localhost/user_plant/public/testUploadGenome.xlsx" target="_blank" download="genome_data"><span class="padding-left-10"><i class="font-20 fas fa-file-upload"></i>download </span></a></p>
        ...
        `)
        $('.link').append(`  <li class="nav-item ">
             <a class="nav-link active" id="tab-5-3" data-toggle="tab" href="#contact-5-3" role="tab" aria-controls="contact-5-3" aria-selected="false">Genome</a>
         </li> `)
      }
     }
 </script>